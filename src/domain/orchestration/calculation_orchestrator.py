...
class CalculationOrchestrator:
    ...
    def _calculate_from_fresh_nfl(
        ...
        team_stats_dict, league_averages, _ = self._league_cache.get_or_compute_league_stats(
            season.year,
            season_type_filter,
            config_hash,
            configuration,
        ...
        all_games_data = self._league_cache.get_play_data(season.year, 'ALL')
        ...
        game_results = self._league_cache.get_cached_game_results(
            season.year, season_type_filter, config_hash
        )
